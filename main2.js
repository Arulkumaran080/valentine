document.addEventListener("DOMContentLoaded", function () {
  ...
  function angry() {
    ...
    mainImg.src = "images/page1/sad1.gif";
  
    absImg.style.display = "flex";
  
    images.forEach(function (image) {
      image.src = "images/page1/sad1.gif";
    });
  }
  function happy() {
    // get all image with class image1 and change the src
    ...
    absImg.style.display = "flex";
    var mainImg = document.getElementById("mainImg");
    mainImg.src = "images/page1/happy3.gif";
  
    images.forEach(function (image) {
      image.src = "images/page1/heart.gif";
    });
  }
  ...
  function normal() {
    ...
    var mainImg = document.getElementById("mainImg");
    mainImg.src = "images/page1/happy1.gif";
  }
